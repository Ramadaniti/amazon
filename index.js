...
function drawItem(data)
{
    ...
    {
        var getOldData=JSON.parse( localStorage.getItem('prodcut'));// array
        console.log(getOldData)
       getOldData.push(data); // old + new 
        var arrString=JSON.stringify(getOldData);
        localStorage.setItem('prodcut',arrString); // override
    }
    div.append(h2,img,h4,but);
...
//     for(var i=0;i<prodcuts.length;i++)
//     {
//         if(prodcuts[i].category=="smartphones")
//         {
//         drawItem(prodcuts[i])
//         }
//     }
...
//     for(var i=0;i<prodcuts.length;i++)
//     {
//         if(prodcuts[i].category=="fragrances")
//         {
//         drawItem(prodcuts[i])
//         }
//     }
...
//     for(var i=0;i<prodcuts.length;i++)
//     {
//         if(prodcuts[i].category=="laptops")
//         {
//         drawItem(prodcuts[i])
//         }
//     }
...
function show(filter)
{
    ...
    for(var i=0;i<prodcuts.length;i++)
    {
        if(prodcuts[i].category==filter.innerHTML)
        {
        drawItem(prodcuts[i])
        }
    }
...
function getCart()
{
    var data=JSON.parse( localStorage.getItem('prodcut'));
